...
//
//class UCTorigParallelPolicy(val rollouts: Int) : Policy() {
//
...
//
//        val treeNodeList: MutableList<DefaultMCTSTreeNode> = Collections.synchronizedList(ArrayList())
//
...
//                val index = node.children
//                    .indexOfFirst { it.simulations.get() == 0 }
//                    .takeUnless { it == -1 } ?: node.children.map {
...
//                        throw IllegalStateException("Shouldn't be NaN!")
//                    }
...
//                var innerCurrent: DefaultMCTSTreeNode? = node
...
//            }
//
//            // TODO: maybe as long as there are results, we process them,
//            //       and only then move onto adding new rollouts
//
...
//
//                var current: DefaultMCTSTreeNode? = node
//                while (current != null) {
