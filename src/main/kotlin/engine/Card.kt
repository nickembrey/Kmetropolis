...
enum class Card(
    ...
    WITCH(type = CardType.ACTION, cost = 5, addCards = 2, effectList = listOf(CardEffect.WitchEffect)),
    ...
    MONEYLENDER(type = CardType.ACTION, cost = 4, effectList = listOf(CardEffect.MoneylenderEffect)),
    MILITIA(type = CardType.ACTION, cost = 4, addCoins = 2, effectList = listOf(CardEffect.MilitiaEffect)),
    CHAPEL(type = CardType.ACTION, cost = 2, effectList = listOf(CardEffect.ChapelEffect)),
    VILLAGE(type = CardType.ACTION, cost = 3, addCards = 1, addActions = 2),
    WORKSHOP(type = CardType.ACTION, cost = 3, effectList = listOf(CardEffect.WorkshopEffect)),
